...
-- Seed the two accounts already present in "User ระบบคน.xlsx" so Setting isn't
-- locked out on first run — editing it requires being logged in as someone,
-- and with an empty table nobody could ever log in to upload the first file.
insert into public.login_users (position, username, password, menu_access)
values
  ('เถ้าแก่', 'Bew', '1234', 'All'),
  ('HR', 'Atom', '1234', 'All')
